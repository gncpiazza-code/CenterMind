...
__all__ = ["generar_reporte_cuentas_corrientes"]

# ----------------------------- Configuración de Sucursales -----------------------------
# Se puede inyectar desde fuera: cuentascorrientes.SUCURSALES_MAP = {"1": "Chaco", ...}
SUCURSALES_MAP: dict = {}
...
def generar_reporte_cuentas_corrientes(path_excel: str, out_dir: str, dist_nombre: str = "") -> str:
