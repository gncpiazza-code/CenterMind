# -*- coding: utf-8 -*-
"""
Shelfy — Panel Maestro v4 (tkinter)
========================================
...
class ShelfyPanel:
    ...
    def _setup_window(self) -> None:
        self.root.title("Shelfy · Panel Maestro")
    ...
    def _build_layout(self) -> None:
        ...
        tk.Label(topbar, text="SHELFY", fg=AMBER, bg=SIDEBAR_BG,
