...
import { type VendedorRanking, type SucursalStats } from '@/lib/api';
      ...
      <div className="p-8 border-b border-slate-50 flex items-center justify-between sticky top-0 bg-white/80 backdrop-blur-xl z-20">
        ...
        {sucursalLabel && (
          <motion.span 
            ...
            className="text-[10px] font-black tracking-[0.15em] uppercase text-blue-600 bg-blue-50/50 px-4 py-2 rounded-2xl border border-blue-100/50 shadow-sm"
          >
            {sucursalLabel}
          </motion.span>
        )}
