...
const ALL_NAV: MobileNavItem[] = [
  { href: "/visor",                label: "Evaluar",      icon: Eye,             roles: ["superadmin", "admin", "supervisor", "evaluador", "compania", "espectador"], permisoKey: "action_evaluar_exhibiciones" },
  { href: "/dashboard",            label: "Dashboard",    icon: LayoutDashboard, roles: ["superadmin", "admin", "supervisor", "compania", "espectador"],               permisoKey: "menu_dashboard" },
  { href: "/supervision",          label: "Supervisión",  icon: BarChart2,        roles: ["superadmin", "admin", "supervisor", "compania", "espectador"],               permisoKey: "menu_supervision" },
  { href: "/estadisticas",         label: "Estadísticas", icon: TrendingUp,       roles: ["superadmin", "admin", "supervisor", "compania", "evaluador", "espectador"] },
  { href: "/objetivos",            label: "Objetivos",    icon: Target,           roles: ["superadmin", "admin", "supervisor", "compania", "espectador"],               permisoKey: "menu_objetivos" },
];
