...
> 1. Lee los 4 archivos de documentación (`CLAUDE.md`, `progress.md`, `arquitectura.md`, `frontend.md`).
> 2. Compara el estado actual del repositorio con lo descrito en esos archivos.
> 3. Realiza los edits necesarios usando `replace_file_content` o `multi_replace_file_content`.
> 4. Informa al usuario: "Documentación actualizada de acuerdo a la skill de sincronización".
